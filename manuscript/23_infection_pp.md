...
## What are the principles of infection control in critical care?
...
### Pathogens and method of contagion
...
- VRE: 3 negative stool cultures each 1 week apart but as with C difficle some concern about recolonisation and some conflicting recommendations suggest no point in culturing previous infected patients within a year as they tend to remain positive; active surveillance as for mrsa beneficial
...
- [Yokoe DS, Anderson DJ, Berenholtz SM et al. A compendium of strategies to prevent healthcare-associated infections in acute care hospitals: 2014 updates. *Infect Control Hosp Epidemiol*. 2014;**35**:967-977.](http://dx.doi.org/10.1086/677216)
    - Update to the original 2008 document
    - SSI
        + do not remove hair where possible, never use razors
        + control bloos glucose in the periop perios
        + maintain normothermia
    - CLABSI
        + Daily chlorhexidine washes
        + Avoid femoral CVC lines in the obese
        + Change dressings, and clean site with CHG, every 5--7 days
        + change blood or lipid giving sets at least every 96 hours
        + Antibiotic impregnated CVC (Grade 1 evidence??)
        + CHG containing dressings
        + Use antimicrobial locks
- [Climo MW, Yokoe DS, Warren DK et al. Effect of Daily Chlorhexidine Bathing on Hospital-Acquired Infection. *N Engl J Med*. 2013;**368**:533-542.](http://dx.doi.org/10.1056/NEJMoa1113849)


## What measures are effective in controlling the spread of MRSA?
...
- [Huang SS, Septimus E, Kleinman K et al. Targeted versus Universal Decolonization to Prevent ICU Infection. *New Engl J Med*. 2013;**368**:2255-2265.](http://dx.doi.org/doi: 10.1056/NEJMoa1207290)
...
- [Jarlier V, Trystram D, Brun-Buisson C et al. Curbing Methicillin-Resistant Staphylococcus aureus in 38 French Hospitals Through a 15-Year Institutional Control Program. *Arch Intern Med*. 2010;**170**:552-559.](http://dx.doi.org/10.1001/archinternmed.2010.32)
    - French program report
    - alcohol based hand gel most important intervention
    - overall program reduced MRSA infection by 50%

- [Cepeda JA, Whitehouse T, Cooper B et al. Isolation of patients in single rooms or cohorts to reduce spread of MRSA in intensive-care units: prospective two-centre study. *Lancet*. 2005;**365**:10-10.](http://dx.doi.org/10.1016/S0140-6736(05)17783-6)
